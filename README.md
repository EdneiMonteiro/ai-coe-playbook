...
Este repositório começou com o artigo **Centro de Excelência em Inteligência Artificial (CoE de IA)** e foi organizado para evoluir como um playbook vivo: além do texto principal, pode receber templates, diagramas, checklists, referências e futuras versões com estudos de caso.
